...
def fetch_exchange_data(fromCurrency,toCurrency):
    request_url = f"https://www.alphavantage.co/query?function=FX_DAILY&from_symbol={fromCurrency}&to_symbol={toCurrency}&interval=60min&outputsize=full&apikey={API_KEY}&datatype=csv"
    print(request_url)
...
if __name__ == "__main__":
    ...
    fig = line(x=dates, y=rates, title="Daily Exchange Rate", labels= {"x": "Month", "y": "Exchange Rate"})
    fig.show()